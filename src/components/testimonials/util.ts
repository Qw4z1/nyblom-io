...
export const naasTestimonials: iTestimonial[] = [
  ...
  },
  {
    ...
    quote:
      "Viktor was brought in to lead the transition from agency to inhouse team and worked in the management team for 2.5 years. His ability to explain technical challenges in simple terms was a huge asset to us founders. Viktor left a legacy in the form of a solid foundation in terms of running the techorganisation that now enables us to scale rapidly. I've lost count of the number of times I've said to other parts of the company to look to the tech org for inspiration on processes.",
  },
];
