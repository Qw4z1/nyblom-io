...
Let's go through a real case and define an Ideal Customer Profile for my <Link href="/cto-coaching">CTO coaching</Link> by answering the following questions:
...
- They want to transition from <Link href="/blog/the_four_stages_of_a_startup_cto">one stage to the next</Link> (need to go through a transformation)
- They want to increase the efficiency and effectiveness of their tech org (ship more and ship more of the Right Things)
- They want to gain more clarity and confidence as leaders

### 😰 What are the pain points and challenges they are facing?

- They are struggling with retention
- They have trouble finding the right developers
- They feel like they are often in firefighting mode with the tech (critical bugs)
- They are feeling overwhelmed, but features are still not shipped fast enough

### 👥 What are some common behaviors and traits?

- First-time founders OR first-time CTO build tech
- Technology company (eg not ecom)
- Tech is the bottleneck (this is a good thing!)

### ⚖️ What is the current state (three or more of)?

- More than 20 employees (most problems are people problems)
- More than 20 m sek yearly revenue (sales is not a bottleneck)
- More than 20 m sek in funding
...
If you want to read more about what I do you can find the link <Link href="/cto-coaching">HERE</Link>.
