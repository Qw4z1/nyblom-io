...
This is a topic that is less discussed. So with this post, I wanted to explore three ways to exit: The IPO, The Acquisition, and The Private Sale.

## The Initial Public Offering

Filing for an IPO essentially means that a company issues new shares that an investment bank then places in the public markets. Taking a company public requires a tremendous amount of work on the company's part to comply with regulations around public markets and allow for.
...
Finally, depending on how the market sentiment looks, this also may not be a viable option. For example, 2022 was a year in which many companies chose to cancel their IPO plans[^3]. I personally missed out on an exit in early 2022 due to the company canceling its IPO when Russia invaded Ukraine.

## The Acquisition

An acquisition is when another company buys a majority or (more commonly) all of the shares in the startup. An acquisition is very much a viable strategy and about ten times as common[^4] as an IPO. The reason why it’s more common is that first of all, you only need to convince one buyer. Compare this with the case of an IPO where you need to convince hundreds or thousands of investors to buy parts of your company.
...
* Ask current investors on the cap table. This might be an option if you have investors there who you know have deep pockets. Depending on when the last round happened, you might need to give a fairly steep discount (20-50%).
* Find a platform tailored for secondaries. Platforms such as [Tioex](https://www.tioex.com) or [Seedrs](https://www.seedrs.com/invest/marketplace) act as marketplaces for secondaries.
...
[^5]: There is no way the buyer could recruit the founders normally, so they pay a premium to get their knowledge. This is particularly common in the case where the founders are experts in some domain, such as AI. 

[^6]: If you want to learn more about liquidation preferences I highly recommend Scott Kupor's book, [Secrets of Sand Hill Road](https://amzn.to/3i6eujZ).
