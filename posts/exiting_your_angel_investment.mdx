...
If you've read my two previous blog posts on angel investing, you should have a pretty good idea about how to get into deals. At some point you will probably want to get some money back, though.

There is no regulated, public market to buy and sell shares, which makes this a bit tricky.

This topic is less discussed, so with this post, I wanted to explore three ways to make an exit: The IPO, The Acquisition, and The Private Sale.
