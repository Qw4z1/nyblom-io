...
Software based companies are very simple to shut down and if the company clearly is not working out it’s better for both you and the founders to spend both time and money somewhere else. Remember, you want great outcomes! Anything else is to be seen as a distraction. 
