...
Software based companies are very simple to shut down and if the company clearly is not working out it’s better for both you and the founders to spend both time and money somewhere else. Remember, you want great outcomes[^1]. Anything else is to be seen as a distraction. This might sound cold, but remember that the decision and the implementation of the decision are two separate things. You can pass on a round while showing empathy and supporting the founder as they are shutting down what they thought would be their legacy.
