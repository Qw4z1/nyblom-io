...
## 5. And verify with data

Some decisions are one way doors. They are the types of decisions where if you get it wrong you're company is done.

You can't afford to leave those to your gut, because the downside risk is too high. 

## 6. It's a game of contradictions
...
## 9. Being an entrepreneur can be lonely, but it doesn't have to be
