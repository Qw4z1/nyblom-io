...
In my work as a <Link href="/cto-coaching">CTO coach</Link> I've noticed that role of the CTO goes through four different stages. Each stage requires different types of leadership and the transition between them are usually where my clients reach out to me.
...
In this blog post, I will do a deep dive into each archetype, with a discussion at the end where I provide advice for founders and aspiring CTOs.
...
Lastly, if you are a CTO who is feels stuck or overwhelmed in or between any of these four phases I want to help you! Reach out to me directly via [LinkedIn](https://www.linkedin.com/in/viktornyblom/) or [email](mailto:viktor@nyblom.io).
