...
excerpt: "Have you ever experienced days where you've been mostly responding to other people's requests and by the end of the day you're not sure if you've gotten any work done? Then this post is for you!"
tags:
  - Focus
  - Productivity
published: true
...
Most of us have been there. The intention behind it is often rooted in helpfulness and inclusivity. What it leads to, however, is context switching that happens too often, a constant feeling of lack of focus, reduced overall productivity, stress, and eventually burnout[^1].
...
Back before the year 1990 technology was not as omnipresent as it is today. You had faxes and telephones. But the most common way to get someone's attention was to walk over to their desk and tap them on their shoulder[12].

But then email happened. First slowly, then all at once.

Email was especially popular in environments where people sat on different floors or in different buildings[^3]. Suddenly you could just fire off a quick question without having to walk over to the other person's desk.
...
In the context of email only this might be manageable. But add on Slack, Teams, text messages, phone calls, Instagram DMs, Twitter, LinkedIn messages, etc, and this translates into a never-ending loop of checking the next notification to make sure we never miss a thing.[^5]
...
Starting with email, I recommend using something called batching. Simply set a schedule for when you reply to messages, and then reply to them all at once. Batching means you can focus completely on emails when you’re dealing with emails. And completely ignore it the rest of the day. If you get a lot of emails, you might want to time box the batching to an hour or 45 minutes.

I like checking email once a day, before lunch. This gives me the morning to focus on getting my most important work done without spilling into my afternoons. Tim Ferriss checks his email at most once a week. I recommend starting with twice a day and then experimenting with different times to find what works best for you.
...
Public channels have two main advantages. Questions can be answered by anyone in the channel, and the answers get immediately distributed to everyone in the channel. Both advantages reduce the need to spend extra time on distributing information.

In my experience, most people are a bit hesitant to write a lot in public channels[^9]. The most common reason for this is that they don’t want to disturb other people (ironic, right?). My answer to that is always the same. Mute channels, set your computer in Do Not Disturb Mode, set your phone on silent, and turn off all notifications.

Every person is responsible for guarding their focus. This includes guarding their calendar from unnecessary meetings. Do whatever it takes to make sure you decide when to handle inbound, instead of the inbound deciding for you.
...
I know a lot of people complaining that they have too many meetings and then proceed to do absolutely nothing about it. The key is to recognise your priorities[^10] and cut all bad meetings.
...
Both these templates are friendly, non-combative, and gently nudge the person sending the invite towards an async way of working. They also make it clear that you are the person owning your calendar, not the inviting party.
...
The rest of the day is full of random encounters. And that’s OK!
...
Getting on the Maker’s schedule requires you to temporarily inconvenience people you work with. But most people are fine with that when they see the results you produce through focused work[^11].
...
[^2]: Read the full essay [here](https://www.paulgraham.com/makersschedule.html).
...
[^6]: If your problem is that you don't know what to focus on, I've written a <Link href="/blog/the_focusing_question">blog post</Link> about how you can use the Focusing Question as a guide.
...
[^9]: Public channels can of course lead to trying to be first with replying and group think in the actual replies. This is a topic for another post, but for delaying showing responses, check out [Thinking Time](https://thinkingtime.org/). For more information on biases, consensus, and groupthink, check out the [Delphi method](https://en.wikipedia.org/wiki/Delphi_method).

[^10]: which hopefully aligns with your departments and your company's priorities.

[^11]: OK, they might have grumbled a bit at the beginning. But after some time, they have been fine with it.

[^12]: Start at the End author, Dave Lavinsky calls this the "Got-a-Minute Culture". I highly recommend reading this book, as it's rare to find a book that contains so much value.