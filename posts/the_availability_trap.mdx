---
title: "Escaping the Availability Trap: Prioritising Productivity Over Reactivity"
subtitle: ""
...
[^1]: The following study shows that while it actually might take us the same time to finish a task after being interrupted, it increases our stress levels. "The Cost of Interrupted Work: More Speed and Stress", by Gloria Mark, Victor M. Gonzalez, and Justin Harris. https://www.ics.uci.edu/~gmark/chi08-mark.pdf
...
[^6]: If your problem is that you don't know that to focus on, I've written a [blog post](https://www.nyblom.io/blog/the_focusing_question) about how you can use the Focusing Question as a guide.

[^7]: In other words the Instant part of Instant Messaging is a lie.

[^8]: I’ve written a separate blog post on the subject of how to use Slack, and you can find it [here](https://www.nyblom.io/blog/how_to_slack)


[^9]: Public channels can of course lead to trying to be first with replying and group think in the actual replies. This is a topic for another post, but for delaying showing responses, checkout https://thinkingtime.org/. And for more information on biases, consensus and group think, check out the Delphi method. https://en.wikipedia.org/wiki/Delphi_method
