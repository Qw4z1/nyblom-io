...
Here is a short list of tools I actually pay for (some of the links are affiliate links):

* <Link href="https://typefully.com/?via=viktor">Typefully</Link>: Helps me stay organized with content on Twitter/X and LinkedIn.
* <Link href="https://tryastro.app?aff=jmkWL">Astro</Link>: The best ASO tool I've found for keyword research.
* <Link href="https://github.com/features/copilot">Github Copilot</Link>: AI right there in Android Studio.
